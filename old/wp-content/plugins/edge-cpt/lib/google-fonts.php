<?php
if ( ! function_exists( 'illustrator_edge_init_google_fonts_array' ) ) {
	function illustrator_edge_init_google_fonts_array() {

		global $illustrator_edge_fonts_array;
		$illustrator_edge_fonts_array =
			array(
				0   =>
					array(
	...
	add_action('after_setup_theme', 'illustrator_edge_init_google_fonts_array');
}