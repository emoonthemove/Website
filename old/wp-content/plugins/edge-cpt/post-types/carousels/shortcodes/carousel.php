...
class Carousel implements Lib\ShortcodeInterface {
     ...
     *
     * @see edge_cpt_get_carousel_slider_array_vc()
     */
        ...
        vc_map( array(
            ...
            'params' => array(
                array(
                    ...
                    'param_name' => 'carousel',
                    'value' => edge_cpt_get_carousel_slider_array_vc(),
                    'admin_label' => true
                ),
                array(
                    'type' => 'dropdown',
    ...
    public function render($atts, $content = null) {
        ...
        if ($carousel !== '') {
            ...
            $html .= '<div class="edgtf-carousel edgtf-slick-slider-navigation-style" ' .  illustrator_edge_get_inline_attrs($carousel_data_attributes) . '>';
            ...
            if ($query->have_posts()) {
                while($query->have_posts()) {
                    ...
                    $html .= edge_cpt_get_shortcode_module_template_part('carousels', 'carousel-template', '', $carousel_item);
                }
            }
