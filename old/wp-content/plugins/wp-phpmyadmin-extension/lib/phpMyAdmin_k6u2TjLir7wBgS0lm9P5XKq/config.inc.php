...
$cfg['blowfish_secret']					= 'URnA~zbCoB<,|kCU@5VnsoD-?{v\";Aw-' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
$cfg['DefaultLang']						= 'en';		// 'en'
$cfg['Servers'][$i]['only_db']			= array('kaboombg_5or') ;    //i.e. array('db1', 'db2') Show only listed databases
$cfg['PmaAbsoluteUri'] 					= 'http://www.kaboom.bg/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_k6u2TjLir7wBgS0lm9P5XKq/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
