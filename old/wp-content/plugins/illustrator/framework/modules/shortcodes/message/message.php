<?php
namespace IllustratorEdge\Modules\Shortcodes\Message;
...
class Message implements ShortcodeInterface	{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Message', 'illustrator'),
			'base' => $this->base,
			...
			'params' => array_merge(
				...
				\IllustratorEdgeIconCollections::get_instance()->getVCParamsArray(array('element' => 'type', 'value' => 'with_icon')),
				array(
					array(
						'type' => 'colorpicker',
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Border Width (px)','illustrator'),
						'param_name' => 'border_width',
						'description' => esc_html__('Default value is 0','illustrator')
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Color','illustrator'),
						'param_name'  => 'close_icon_color',
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Hover Color','illustrator'),
					...
					array(
						...
						'param_name' => 'content',
						'value' => '<p>'.esc_html__('I am test text for Message shortcode.','illustrator').'</p>',
					)
				)
			)
		) );
	...
	public function render($atts, $content = null) {
		...
		$html = illustrator_edge_get_shortcode_module_template_part('templates/message-holder-template', 'message', '', $params);
