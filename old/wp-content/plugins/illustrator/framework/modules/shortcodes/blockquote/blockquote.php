<?php
namespace IllustratorEdge\Modules\Shortcodes\Blockquote;
...
class Blockquote implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Blockquote', 'illustrator'),
				'base' => $this->getBase(),
				...
				'params' => array(
					array(
						...
						"param_name" => "text",
						"value" => esc_html__("Blockquote text",'illustrator'),
						"save_always" => true
					),
					array(
						"type" => "textfield",
	...
	public function render($atts, $content = null) {
		...
		$html = illustrator_edge_get_shortcode_module_template_part('templates/blockquote-template', 'blockquote', '', $params);
