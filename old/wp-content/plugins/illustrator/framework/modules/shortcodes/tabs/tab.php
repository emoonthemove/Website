<?php
namespace IllustratorEdge\Modules\Shortcodes\Tab;
...
class Tab implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Tab', 'illustrator'),
			'base' => $this->getBase(),
	...
	public function render($atts, $content = null) {
		...
		$output = '';
		$output .= illustrator_edge_get_shortcode_module_template_part('templates/tab-content','tabs', '', $params);
		return $output;
	}
}