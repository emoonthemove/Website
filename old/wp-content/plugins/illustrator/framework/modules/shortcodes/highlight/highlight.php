<?php
namespace IllustratorEdge\Modules\Shortcodes\Highlight;
...
class Highlight implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = illustrator_edge_get_shortcode_module_template_part('templates/highlight-template', 'highlight', '', $params);
