<?php
namespace IllustratorEdge\Modules\Shortcodes\ItemShowcaseListItem;
...
class ItemShowcaseListItem implements ShortcodeInterface{
	...
	public function vcMap() {
		if(function_exists('vc_map')){
			vc_map( 
				array(
					'name' => esc_html__('Item Showcase List Item', 'illustrator'),
					'base' => $this->base,
					...
					'params' => array_merge(
						...
						array(
							array(
								'type'        => 'dropdown',
								'admin_label' => true,
								'heading'     => esc_html__('Item Position','illustrator'),
							...
							array(
								'type'        => 'textfield',
								'heading'     => esc_html__('Item Title','illustrator'),
								'admin_label' => true,
								'param_name'  => 'item_title',
							),
							array(
								'type'        => 'textfield',
								'heading'     => esc_html__('Item Text','illustrator'),
								'admin_label' => true,
								'param_name'  => 'item_text',
							),
							array(
								'type'       => 'textfield',
								'heading'    => esc_html__('Item Link','illustrator'),
	...
	public function render($atts, $content = null) {
		...
		$html = illustrator_edge_get_shortcode_module_template_part('templates/item-showcase-list-item-template', 'item-showcase', '', $params);
