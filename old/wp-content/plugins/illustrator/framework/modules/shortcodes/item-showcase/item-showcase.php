<?php
namespace IllustratorEdge\Modules\Shortcodes\ItemShowcase;
...
class ItemShowcase implements ShortcodeInterface	{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Item Showcase', 'illustrator'),
			'base' => $this->base,
			...
			'params' =>	array(
                ...
                array(
                    'type' => 'textfield',
                    'heading' => esc_html__('Image Top Offset','illustrator'),
                    'admin_label' => true,
                    'value' => '-180px',
                    'save_always' => true,
	...
	public function render($atts, $content = null) {
        ...
        $item_image_style = '';
        $item_image_style .= 'margin-top:' . illustrator_edge_filter_px($image_top_offset) . 'px;';

        $html .= '<div '. illustrator_edge_get_class_attribute($item_showcase_class) . '>';
            $html .= '<div class="edgtf-item-image" '. illustrator_edge_get_inline_style($item_image_style)  .'>';
                if ($item_image != '') {
