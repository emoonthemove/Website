...
if ( ! function_exists('illustrator_edge_contact_form_7_options_map') ) {

	function illustrator_edge_contact_form_7_options_map() {

		illustrator_edge_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7','illustrator'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = illustrator_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1','illustrator')
		));

		//Text Typography

		$typography_text_group = illustrator_edge_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography','illustrator'),
			'description'	=> esc_html__('Setup typography for form elements text','illustrator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = illustrator_edge_add_admin_row(array(
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color','illustrator'),
		));
		...
		$typography_text_row2 = illustrator_edge_add_admin_row(array(
		...
		$typography_text_row3 = illustrator_edge_add_admin_row(array(
		...
		$typography_label_group = illustrator_edge_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography','illustrator'),
			'description'	=> esc_html__('Setup typography for form elements label','illustrator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = illustrator_edge_add_admin_row(array(
		...
		$typography_label_row2 = illustrator_edge_add_admin_row(array(
		...
		$background_border_group = illustrator_edge_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border','illustrator'),
			'description'	=> esc_html__('Setup form elements background and border style','illustrator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = illustrator_edge_add_admin_row(array(
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color','illustrator'),
		));
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency','illustrator'),
		));

		$background_border_row2 = illustrator_edge_add_admin_row(array(
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency','illustrator'),
		));
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color','illustrator'),
		));
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency','illustrator'),
		));

		$background_border_row3 = illustrator_edge_add_admin_row(array(
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width','illustrator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius','illustrator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = illustrator_edge_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding','illustrator'),
			'description'	=> esc_html__('Setup form elements padding','illustrator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = illustrator_edge_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top','illustrator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom','illustrator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = illustrator_edge_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin','illustrator'),
			'description'	=> esc_html__('Setup form elements margin','illustrator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = illustrator_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Top','illustrator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Bottom','illustrator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height','illustrator'),
			'description'	=> esc_html__('Enter height for textarea form element','illustrator'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = illustrator_edge_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography','illustrator'),
			'description'	=> esc_html__('Setup button text typography','illustrator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = illustrator_edge_add_admin_row(array(
		...
		$button_typography_row2 = illustrator_edge_add_admin_row(array(
		...
		$button_background_border_group = illustrator_edge_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border','illustrator'),
			'description'	=> esc_html__('Setup button background and border style','illustrator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = illustrator_edge_add_admin_row(array(
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency','illustrator'),
		));

		$button_background_border_row2 = illustrator_edge_add_admin_row(array(
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color','illustrator'),
		));
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency','illustrator'),
		));

		$button_background_border_row3 = illustrator_edge_add_admin_row(array(
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height','illustrator'),
			'description'	=> esc_html__('Insert form button height','illustrator'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		illustrator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding','illustrator'),
			'description'	=> esc_html__('Enter value for button left and right padding','illustrator'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = illustrator_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2','illustrator')
		));
		...
		$panel_contact_form_style_3 = illustrator_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_3',
			'title'	=> esc_html__('Custom Style 3','illustrator'),
		));
	...
	add_action( 'illustrator_edge_options_map', 'illustrator_edge_contact_form_7_options_map', 19);
