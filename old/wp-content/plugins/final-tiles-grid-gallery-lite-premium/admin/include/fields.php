...
if (ftg_fs()->can_use_premium_code__premium_only())
{
    $this->addField("Links & Lightbox", "lightboxOptions", array(
        ...
        "type" => "textarea",
        "description" => "Custom options for chosen lightbox. Enter params without curly braces.<br>Example: <span style='font-family:monospace'>easing: linear, mode: 'lg-fade'</span>.<br>Documentation: <a href='http://sachinchoolur.github.io/lightGallery/docs/api.html' target='_blank'>LightGallery</a>, <a target='_blank' href='http://dimsemenov.com/plugins/magnific-popup/documentation.html'>Magnific Popup</a>.",
        "proCall" => false,
        "excludeFrom" => array()
    ));
...
if(ftg_fs()->can_use_premium_code__premium_only())
{
    $this->addField("Captions", "captionCustomFields", array(
        "name" => "Custom fields",
        "type" => "textarea",
        "description" => "Insert 1 custom field on each line. Add an optional label after the custom field code.",
        "values" => array(),
        "proCall" => false,
