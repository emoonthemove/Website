...
/**
 * Plugin Name: Final Tiles Grid Gallery - Image Gallery (Premium)
    ...
    class FinalTiles_Gallery
    {
        ...
        public function add_gallery_scripts()
        {
            ...
            if ( ftg_fs()->is__premium_only() ) {
                wp_register_script(
                    'magnific_script',
                    plugins_url( 'lightbox-pro/magnific/script.js', __FILE__ ),
                    array( 'jquery' ),
                    FTGVERSION,
                    true
                );
                wp_register_script(
                    'prettyphoto_script',
                    plugins_url( 'lightbox-pro/prettyphoto/script.js', __FILE__ ),
                    array( 'jquery' ),
                    FTGVERSION,
                    true
                );
                wp_register_script(
                    'colorbox_script',
                    plugins_url( 'lightbox-pro/colorbox/script.js', __FILE__ ),
                    array( 'jquery' ),
                    FTGVERSION,
                    true
                );
                wp_register_script(
                    'fancybox_script',
                    plugins_url( 'lightbox-pro/fancybox/script.js', __FILE__ ),
                    array( 'jquery' ),
                    FTGVERSION,
                    true
                );
                wp_register_script(
                    'swipebox_script',
                    plugins_url( 'lightbox-pro/swipebox/script.js', __FILE__ ),
                    array( 'jquery' ),
                    FTGVERSION,
                    true
                );
                wp_register_script(
                    ...
                    plugins_url( 'lightbox-pro/image-lightbox/js/script.js', __FILE__ ),
                    array( 'jquery' ),
                    FTGVERSION,
                    true
                );
        ...
        public function list_posts__premium_only( $post_type )
        {
            ...
            if ( check_admin_referer( 'FinalTiles_gallery', 'FinalTiles_gallery' ) ) {
                ...
                $args['tax_query'] = array(
                    "relation" => $_POST['ftg_taxonomyOperator'],
                );
                if ( $post_type != null ) {
                ...
                if ( $_POST['post_taxonomy'] ) {
                    foreach ( explode( ",", $_POST['post_taxonomy'] ) as $taxonomy_raw ) {
        ...
        public static function getFieldType( $field )
        {
            ...
            if ( ftg_fs()->is__premium_only() ) {
                ...
                if ( ftg_fs()->is_plan_or_trial( 'ultimate' ) ) {
                    ...
                    if ( $field == "customCaptionIcon" || $field == "hoverZoom" ) {
                        return "text";
                    }
