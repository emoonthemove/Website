...
add_action('after_setup_theme', 'illustrator_edge_admin_map_init', 0);

function illustrator_edge_admin_map_init() {

    do_action('illustrator_edge_before_options_map');
    ...
    do_action('illustrator_edge_options_map');

    do_action('illustrator_edge_after_options_map');
