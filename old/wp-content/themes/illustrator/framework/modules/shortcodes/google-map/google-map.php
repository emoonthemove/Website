<?php
namespace IllustratorEdge\Modules\Shortcodes\GoogleMap;
...
class GoogleMap implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Google Map', 'illustrator'),
				'base' => $this->base,
				...
				'params' => array(
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 1','illustrator'),
						'param_name' => 'address1',
						'admin_label' => true
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 2','illustrator'),
						'param_name' => 'address2',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 3','illustrator'),
						'param_name' => 'address3',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 4','illustrator'),
						'param_name' => 'address4',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Address 5','illustrator'),
						'param_name' => 'address5',
						'admin_label' => true,
					...
					array(
						'type' => 'dropdown',
						'heading' => esc_html__('Custom Map Style','illustrator'),
						'param_name' => 'custom_map_style',
						'value' => array(
							esc_html__('No','illustrator') => 'false',
							esc_html__('Yes','illustrator') => 'true'
						),
						'save_always' => true,
						'description' => esc_html__('Enabling this option will allow Map editing','illustrator')
					),
					array(
						'type' => 'colorpicker',
						'heading' => esc_html__('Color Overlay','illustrator'),
						'param_name' => 'color_overlay',
						'description' => esc_html__('Choose a Map color overlay','illustrator'),
						'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Saturation','illustrator'),
						'param_name' => 'saturation',
						'description' => esc_html__('Choose a level of saturation (-100 = least saturated, 100 = most saturated)','illustrator'),
						'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Lightness','illustrator'),
						'param_name' => 'lightness',
						'description' => esc_html__('Choose a level of lightness (-100 = darkest, 100 = lightest)','illustrator'),
						'dependency' => Array('element' => 'custom_map_style', 'value' => array('true'))
					),
					array(
						'type' => 'attach_image',
						'heading' => esc_html__('Pin','illustrator'),
						'param_name' => 'pin',
						'description' => esc_html__('Select a pin image to be used on Google Map','illustrator')
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Map Zoom','illustrator'),
						'param_name' => 'zoom',
						'description' => esc_html__('Enter a zoom factor for Google Map (0 = whole worlds, 19 = individual buildings)','illustrator')
					),
					array(
						'type' => 'dropdown',
						'heading' => esc_html__('Zoom Map on Mouse Wheel','illustrator'),
						...
						'save_always' => true,
						'description' => esc_html__('Enabling this option will allow users to zoom in on Map using mouse wheel','illustrator')
					),
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Map Height','illustrator'),
	...
	public function render($atts, $content = null) {
		...
		$html = illustrator_edge_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
