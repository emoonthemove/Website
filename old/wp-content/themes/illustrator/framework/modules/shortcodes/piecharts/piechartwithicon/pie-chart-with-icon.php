<?php
namespace IllustratorEdge\Modules\Shortcodes\PieCharts\PieChartWithIcon;
...
class PieChartWithIcon implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Pie Chart With Icon', 'illustrator'),
			'base' => $this->getBase(),
			...
			'params' => array_merge(
				array(
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Size(px)','illustrator'),
						'param_name' => 'size',
						'admin_label' => true,
					...
					array(
						'type' => 'textfield',
						'heading' => esc_html__('Margin below chart (px)','illustrator'),
                    ...
                    array(
                        'type' => 'colorpicker',
                        'heading' => esc_html__('Active Color','illustrator'),
                        'param_name' => 'active_color',
                        'group' => esc_html__('Design Options','illustrator')
                    ),
                    array(
                        'type' => 'colorpicker',
                        'heading' => esc_html__('Inactive Color','illustrator'),
				...
				array(
					array(
						...
						'dependency' => Array('element' => 'icon_pack', 'value' => illustrator_edge_icon_collections()->getIconCollectionsKeys()),
						'group' => esc_html__('Design Options','illustrator'),
					),
					array(
						'type' => 'textfield',
	...
	public function render($atts, $content = null)
	{
		...
		$html = illustrator_edge_get_shortcode_module_template_part('templates/pie-chart-with-icon', 'piecharts/piechartwithicon', '', $params);
	...
	private function getPieChartIcon($params) {
		...
		$pie_chart_icon = illustrator_edge_icon_collections()->renderIcon( $params[$icon], $params['icon_pack'], $iconStyles );
