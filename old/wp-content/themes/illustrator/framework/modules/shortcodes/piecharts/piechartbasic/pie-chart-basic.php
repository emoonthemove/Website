<?php
namespace IllustratorEdge\Modules\Shortcodes\PieCharts\PieChartBasic;
...
class PieChartBasic implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Pie Chart', 'illustrator'),
			'base' => $this->getBase(),
			...
			'params' => array(
				array(
					'type' => 'dropdown',
					'heading' => esc_html__('Type of Central text','illustrator'),
					'param_name' => 'type_of_central_text',
					'value' => array(
						esc_html__('Percent','illustrator')  => 'percent',
	...
	public function render($atts, $content = null) {
		...
		$html = illustrator_edge_get_shortcode_module_template_part('templates/pie-chart-basic', 'piecharts/piechartbasic', '', $params);
