...
use IllustratorEdge\Modules\Header\Types;
/**
...
class HeaderFactory {
    ...
    public function validHeaderObject($header_object = null) {
        ...
        return is_subclass_of($header_object, 'IllustratorEdge\Modules\Header\Lib\HeaderType');
    }
        ...
        if($headerType !== '') {
            switch($headerType) {
				...
				case 'header-expanding':
					$this->headerObject = new Types\HeaderExpanding();
					break;
                default:
                    break;
            }
