 ...
 */
class IllustratorEdgeSocialIconWidget extends IllustratorEdgeWidget {
    /**
    ...
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Edge Social Icon Widget', 'illustrator') // Name
        );
    ...
    protected function setParams() {
        $this->params = array_merge(
            illustrator_edge_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Link', 'illustrator'),
                    'name' => 'link',
                    'description' => ''
                ),
                array(
                    'type' => 'dropdown',
                    'title' => esc_html__('Target', 'illustrator'),
                    'name' => 'target',
                    'options' => array(
                ...
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Text Size (px)', 'illustrator'),
                    'name' => 'text_size',
                    'description' => ''
                ),
                array(
                ...
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Hover Color', 'illustrator'),
                    'name' => 'hover_color',
                    'description' => ''
                ),
                array(
                    'type' => 'textfield',
                    'title' => esc_html__('Margin', 'illustrator'),
                    'name' => 'margin',
    ...
    public function widget($args, $instance) {
        ...
        <a class="edgtf-social-icon-widget-holder" <?php echo illustrator_edge_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php illustrator_edge_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
