...
if ( $related_products ) : ?>
	...
	<section class="related products "data-columns-number="<?php echo apply_filters( 'woocommerce_related_products_columns', $columns ); ?>">

		<div class="edgtf-related-products-title-holder">
			<span><?php esc_html_e( 'Related Products', 'illustrator' ); ?></span>
