...
/*
  Class: IllustratorEdgeIconCollections
...
class IllustratorEdgeIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new IllustratorEdgeIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new IllustratorEdgeIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new IllustratorEdgeIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new IllustratorEdgeLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('linear_icons', new IllustratorEdgeLinearIcons('Linear Icons', 'linear_icons'));
        $this->addIconCollection('simple_line_icons', new IllustratorEdgeSimpleLineIcons('Simple Line Icons', 'simple_line_icons'));
        $this->addIconCollection('dripicons', new IllustratorEdgeDripicons('Dripicons', 'dripicon'));
        $this->addIconCollection('ico_moon', new IllustratorEdgeIcoMoonIcons('Ico Moon', 'ico_moon'));
    }
    ...
    public function getIconCollectionIcons(iIllustratorEdgeIconCollection $collection) {
...
if ( ! function_exists( 'illustrator_edge_activate_theme_icons' ) ) {

	function illustrator_edge_activate_theme_icons() {
		global $illustrator_edge_IconCollections;
		$illustrator_edge_IconCollections = IllustratorEdgeIconCollections::get_instance();
	}

	add_action('after_setup_theme', 'illustrator_edge_activate_theme_icons');
}