<?php
namespace IllustratorEdge\Modules\Shortcodes\PricingTables;
...
class PricingTables implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Pricing Tables', 'illustrator'),
				'base' => $this->base,
				...
				'params' => array(
					array(
						...
						'param_name' => 'columns',
						'value' => array(
							esc_html__('Two','illustrator')       => 'edgtf-two-columns',
							esc_html__('Three','illustrator')     => 'edgtf-three-columns',
							esc_html__('Four','illustrator')      => 'edgtf-four-columns',
						),
						'save_always' => true,
					)
				),
