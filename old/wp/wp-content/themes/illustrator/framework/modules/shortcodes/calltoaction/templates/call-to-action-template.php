...
<?php } ?>
	<div class="edgtf-call-to-action <?php echo esc_attr($type) ?>">
		...
		if ($grid_size == "75") { ?>
			<div class="edgtf-call-to-action-row-75-25 clearfix" <?php echo illustrator_edge_get_inline_style($call_to_action_styles) ?>>
		<?php } elseif ($grid_size == "66") { ?>
			<div class="edgtf-call-to-action-row-66-33 clearfix" <?php echo illustrator_edge_get_inline_style($call_to_action_styles) ?>>
		<?php } else { ?>
			<div class="edgtf-call-to-action-row-50-50 clearfix" <?php echo illustrator_edge_get_inline_style($call_to_action_styles) ?>>
		<?php } ?>
				...
				<?php } ?>
					<div class="edgtf-call-to-action-text" <?php echo illustrator_edge_get_inline_style($content_styles) ?>><?php echo do_shortcode($content); ?></div>
				</div>
				...
				<?php if ($show_button == 'yes') { ?>
					<div class="edgtf-button-wrapper edgtf-call-to-action-column2 edgtf-call-to-action-cell" style ="text-align: <?php echo esc_attr($button_position) ?> ;">
						<?php echo illustrator_edge_get_button_html($button_parameters); ?>
					</div>
				<?php } ?>
			</div>
		<?php if ($content_in_grid == 'yes' && $full_width == 'yes') { ?>
