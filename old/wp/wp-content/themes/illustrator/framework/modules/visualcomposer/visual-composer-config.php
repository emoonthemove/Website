...
if ( ! function_exists('illustrator_edge_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function illustrator_edge_configure_visual_composer() {
	...
	add_action('vc_after_init', 'illustrator_edge_configure_visual_composer');

}


if ( ! function_exists('illustrator_edge_configure_visual_composer_grid_elemets') ) {
	...
	function illustrator_edge_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'illustrator_edge_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('illustrator_edge_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function illustrator_edge_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'illustrator_edge_configure_visual_composer_frontend_editor');
}
...
/*** Row ***/
if ( ! function_exists('illustrator_edge_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function illustrator_edge_vc_row_map()
	{

		$animations = array(
			esc_html__('No animation', 'illustrator') => '',
			esc_html__('Elements Shows From Left Side', 'illustrator') 		=>	'edgtf-element-from-left',
			esc_html__('Elements Shows From Right Side', 'illustrator')		=> 	'edgtf-element-from-right',
			esc_html__('Elements Shows From Top Side', 'illustrator')		=>	'edgtf-element-from-top',
			esc_html__('Elements Shows From Bottom Side', 'illustrator')	=>	'edgtf-element-from-bottom',
			esc_html__('Elements Shows From Fade', 'illustrator')			=>	'edgtf-element-from-fade'
		);

		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Row Type', 'illustrator'),
			'param_name' => 'row_type',
			'value' => array(
				esc_html__('Row', 'illustrator') => 'row',
				esc_html__('Parallax', 'illustrator') => 'parallax'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Content Width', 'illustrator'),
			'param_name' => 'content_width',
			'value' => array(
				esc_html__('Full Width', 'illustrator') => 'full-width',
				esc_html__('In Grid', 'illustrator') => 'grid'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Header Style', 'illustrator'),
			'param_name' => 'header_style',
			'value' => array(
				esc_html__('Default', 'illustrator') => '',
				esc_html__('Light', 'illustrator') => 'edgtf-light-header',
				esc_html__('Dark', 'illustrator') => 'edgtf-dark-header'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Anchor ID', 'illustrator'),
			'param_name' => 'anchor',
			'value' => '',
			'description' => esc_html__('For example "home"', 'illustrator')
		));
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Video Background', 'illustrator'),
			'value' => array(
				esc_html__('No', 'illustrator') => '',
				esc_html__('Yes', 'illustrator') => 'show_video'
			),
			'param_name' => 'video',
			'description' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Video Overlay', 'illustrator'),
			'value' => array(
				esc_html__('No', 'illustrator') => '',
				esc_html__('Yes', 'illustrator') => 'show_video_overlay'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Video Overlay Image (pattern)', 'illustrator'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (webm) File URL', 'illustrator'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (mp4) file URL', 'illustrator'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (ogv) file URL', 'illustrator'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Video Preview Image', 'illustrator'),
			'value' => '',
		...
		vc_add_param("vc_row", array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Full Screen Height', 'illustrator'),
		...
		vc_add_param("vc_row", array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Stay Full Screen On Touch Devices', 'illustrator'),
			'param_name' => 'stay_full_screen_on_touch_devices',
			'value' => array(
					esc_html__('No', 'illustrator') => 'no',
					esc_html__('Yes', 'illustrator')=> 'yes'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Vertically Align Content In Middle', 'illustrator'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Section Height', 'illustrator'),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Parallax Background image', 'illustrator'),
			'value' => '',
			'param_name' => 'parallax_background_image',
			'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'illustrator'),
			'dependency' => Array('element' => 'row_type', 'value' => array('parallax'))
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Parallax speed', 'illustrator'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('CSS Animation', 'illustrator'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Transition delay (ms)', 'illustrator'),
	...
	add_action('vc_after_init', 'illustrator_edge_vc_row_map');
}
