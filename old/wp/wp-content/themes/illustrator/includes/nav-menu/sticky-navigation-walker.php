 ...
 */
if (!class_exists('IllustratorEdgeStickyNavigationWalker')) {
	class IllustratorEdgeStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if (illustrator_edge_options()->getOptionValue('enable_wide_menu_background') == "yes"){
